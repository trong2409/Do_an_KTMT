...
"""autogenerated by genpy from opc_ros/ActionSetRawActionResult.msg. Do not edit."""
import codecs
import sys
...
class ActionSetRawActionResult(genpy.Message):
  ...
  _type = "opc_ros/ActionSetRawActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','opc_ros/ActionSetRawResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = opc_ros.msg.ActionSetRawResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = opc_ros.msg.ActionSetRawResult()
