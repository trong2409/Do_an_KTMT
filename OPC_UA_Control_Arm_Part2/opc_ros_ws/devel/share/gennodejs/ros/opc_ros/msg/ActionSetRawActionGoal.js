...
class ActionSetRawActionGoal {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('goal')) {
        ...
        this.goal = new ActionSetRawGoal();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = ActionSetRawGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static getMessageSize(object) {
    ...
    length += ActionSetRawGoal.getMessageSize(object.goal);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new ActionSetRawActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = ActionSetRawGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new ActionSetRawGoal()
    }
...
module.exports = ActionSetRawActionGoal;
