...
(cl:defmethod cl:initialize-instance :after ((m <Mecanum>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Mecanum)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name opc_ros-msg:<Mecanum> is deprecated: use opc_ros-msg:Mecanum instead.")))

(cl:ensure-generic-function 'velocity-val :lambda-list '(m))
(cl:defmethod velocity-val ((m <Mecanum>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader opc_ros-msg:velocity-val is deprecated.  Use opc_ros-msg:velocity instead.")
  (velocity m))

(cl:ensure-generic-function 'direction-val :lambda-list '(m))
(cl:defmethod direction-val ((m <Mecanum>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader opc_ros-msg:direction-val is deprecated.  Use opc_ros-msg:direction instead.")
  (direction m))

(cl:ensure-generic-function 'angular_rate-val :lambda-list '(m))
(cl:defmethod angular_rate-val ((m <Mecanum>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader opc_ros-msg:angular_rate-val is deprecated.  Use opc_ros-msg:angular_rate instead.")
  (angular_rate m))
