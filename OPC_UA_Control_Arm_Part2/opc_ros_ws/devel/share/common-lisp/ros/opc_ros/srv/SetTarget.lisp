...
(cl:defmethod cl:initialize-instance :after ((m <SetTarget-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetTarget-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name opc_ros-srv:<SetTarget-request> is deprecated: use opc_ros-srv:SetTarget-request instead.")))
...
(cl:defmethod is_enable-val ((m <SetTarget-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader opc_ros-srv:is_enable-val is deprecated.  Use opc_ros-srv:is_enable instead.")
  (is_enable m))
...
(cl:defmethod cl:initialize-instance :after ((m <SetTarget-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetTarget-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name opc_ros-srv:<SetTarget-response> is deprecated: use opc_ros-srv:SetTarget-response instead.")))
