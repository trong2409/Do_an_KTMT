...
get_filename_component(_filename "/home/hiwonder/ros/src/jetmax_buildin_funcs/lab_config/srv/ChangeRange.srv" NAME_WE)
add_custom_target(_lab_config_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "lab_config" "/home/hiwonder/ros/src/jetmax_buildin_funcs/lab_config/srv/ChangeRange.srv" ""
)

get_filename_component(_filename "/home/hiwonder/ros/src/jetmax_buildin_funcs/lab_config/srv/GetRange.srv" NAME_WE)
add_custom_target(_lab_config_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "lab_config" "/home/hiwonder/ros/src/jetmax_buildin_funcs/lab_config/srv/GetRange.srv" ""
)

get_filename_component(_filename "/home/hiwonder/ros/src/jetmax_buildin_funcs/lab_config/srv/GetAllColorName.srv" NAME_WE)
add_custom_target(_lab_config_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "lab_config" "/home/hiwonder/ros/src/jetmax_buildin_funcs/lab_config/srv/GetAllColorName.srv" ""
)

get_filename_component(_filename "/home/hiwonder/ros/src/jetmax_buildin_funcs/lab_config/srv/StashRange.srv" NAME_WE)
add_custom_target(_lab_config_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "lab_config" "/home/hiwonder/ros/src/jetmax_buildin_funcs/lab_config/srv/StashRange.srv" ""
)
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/lab_config)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/lab_config\")")
  # install generated code
  install(
