...
#sys.path.insert(2, '/home/hiwonder/ros/src/jetmax_buildin_funcs/jetmax_control_custom/scripts')
...
class JetMaxControl:
    def __init__(self):
        ...
        self.buzzer_sub = rospy.Subscriber('/jetmax/buzzer', Bool,
                                           queue_size = 1,
                                           callback=self.run_buzzer)
    ...
    def update(self):
        while not rospy.is_shutdown():
            ...
            joint_states = []
            for i in range(3):
                #servo = Uint16, joint = float32 (angle)
