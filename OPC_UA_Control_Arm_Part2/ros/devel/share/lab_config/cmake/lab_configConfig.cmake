...
if("TRUE" STREQUAL "TRUE")
  set(lab_config_SOURCE_PREFIX /home/hiwonder/ros/src/jetmax_buildin_funcs/lab_config)
  set(lab_config_DEVEL_PREFIX /home/hiwonder/ros/devel)
  ...
  set(lab_config_INSTALL_PREFIX /home/hiwonder/ros/install)
...
if(NOT "/home/hiwonder/ros/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'lab_config' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/hiwonder/ros/src/jetmax_buildin_funcs/lab_config/${idir}'.  ${_report}")
    endif()
...
foreach(depend ${depends})
  ...
  list(APPEND lab_config_EXPORTED_TARGETS ${${lab_config_dep}_EXPORTED_TARGETS})
endforeach()
