...
(cl:defmethod color_name-val ((m <SetTarget-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader object_tracking-srv:color_name-val is deprecated.  Use object_tracking-srv:color_name instead.")
  (color_name m))
