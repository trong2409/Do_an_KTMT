...
(cl:defmethod cl:initialize-instance :after ((m <JetMax>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'JetMax)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name jetmax_control-msg:<JetMax> is deprecated: use jetmax_control-msg:JetMax instead.")))
...
(cl:defmethod joint1-val ((m <JetMax>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jetmax_control-msg:joint1-val is deprecated.  Use jetmax_control-msg:joint1 instead.")
  (joint1 m))

(cl:ensure-generic-function 'joint2-val :lambda-list '(m))
(cl:defmethod joint2-val ((m <JetMax>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jetmax_control-msg:joint2-val is deprecated.  Use jetmax_control-msg:joint2 instead.")
  (joint2 m))

(cl:ensure-generic-function 'joint3-val :lambda-list '(m))
(cl:defmethod joint3-val ((m <JetMax>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jetmax_control-msg:joint3-val is deprecated.  Use jetmax_control-msg:joint3 instead.")
  (joint3 m))

(cl:ensure-generic-function 'servo1-val :lambda-list '(m))
(cl:defmethod servo1-val ((m <JetMax>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jetmax_control-msg:servo1-val is deprecated.  Use jetmax_control-msg:servo1 instead.")
  (servo1 m))

(cl:ensure-generic-function 'servo2-val :lambda-list '(m))
(cl:defmethod servo2-val ((m <JetMax>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jetmax_control-msg:servo2-val is deprecated.  Use jetmax_control-msg:servo2 instead.")
  (servo2 m))

(cl:ensure-generic-function 'servo3-val :lambda-list '(m))
(cl:defmethod servo3-val ((m <JetMax>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jetmax_control-msg:servo3-val is deprecated.  Use jetmax_control-msg:servo3 instead.")
  (servo3 m))

(cl:ensure-generic-function 'pwm1-val :lambda-list '(m))
(cl:defmethod pwm1-val ((m <JetMax>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jetmax_control-msg:pwm1-val is deprecated.  Use jetmax_control-msg:pwm1 instead.")
  (pwm1 m))

(cl:ensure-generic-function 'pwm2-val :lambda-list '(m))
(cl:defmethod pwm2-val ((m <JetMax>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jetmax_control-msg:pwm2-val is deprecated.  Use jetmax_control-msg:pwm2 instead.")
  (pwm2 m))

(cl:ensure-generic-function 'sucker-val :lambda-list '(m))
(cl:defmethod sucker-val ((m <JetMax>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jetmax_control-msg:sucker-val is deprecated.  Use jetmax_control-msg:sucker instead.")
  (sucker m))
