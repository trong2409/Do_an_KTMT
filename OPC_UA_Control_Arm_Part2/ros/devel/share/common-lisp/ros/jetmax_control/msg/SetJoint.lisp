...
(cl:defmethod cl:initialize-instance :after ((m <SetJoint>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetJoint)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name jetmax_control-msg:<SetJoint> is deprecated: use jetmax_control-msg:SetJoint instead.")))

(cl:ensure-generic-function 'data-val :lambda-list '(m))
(cl:defmethod data-val ((m <SetJoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jetmax_control-msg:data-val is deprecated.  Use jetmax_control-msg:data instead.")
  (data m))
