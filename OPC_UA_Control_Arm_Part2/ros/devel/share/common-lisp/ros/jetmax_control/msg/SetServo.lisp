...
(cl:defmethod cl:initialize-instance :after ((m <SetServo>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetServo)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name jetmax_control-msg:<SetServo> is deprecated: use jetmax_control-msg:SetServo instead.")))
