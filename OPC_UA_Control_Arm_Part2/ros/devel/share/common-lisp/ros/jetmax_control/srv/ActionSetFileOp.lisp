...
(cl:defmethod cl:initialize-instance :after ((m <ActionSetFileOp-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ActionSetFileOp-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name jetmax_control-srv:<ActionSetFileOp-request> is deprecated: use jetmax_control-srv:ActionSetFileOp-request instead.")))

(cl:ensure-generic-function 'file_name-val :lambda-list '(m))
(cl:defmethod file_name-val ((m <ActionSetFileOp-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jetmax_control-srv:file_name-val is deprecated.  Use jetmax_control-srv:file_name instead.")
  (file_name m))

(cl:ensure-generic-function 'data-val :lambda-list '(m))
(cl:defmethod data-val ((m <ActionSetFileOp-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jetmax_control-srv:data-val is deprecated.  Use jetmax_control-srv:data instead.")
  (data m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ActionSetFileOp-request>)))
  ...
  "jetmax_control/ActionSetFileOpRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ActionSetFileOp-request)))
  "Returns string type for a service object of type 'ActionSetFileOp-request"
  "jetmax_control/ActionSetFileOpRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <ActionSetFileOp-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ActionSetFileOp-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name jetmax_control-srv:<ActionSetFileOp-response> is deprecated: use jetmax_control-srv:ActionSetFileOp-response instead.")))
...
(cl:defmethod message-val ((m <ActionSetFileOp-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jetmax_control-srv:message-val is deprecated.  Use jetmax_control-srv:message instead.")
  (message m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ActionSetFileOp-response>)))
  ...
  "jetmax_control/ActionSetFileOpResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ActionSetFileOp-response)))
  "Returns string type for a service object of type 'ActionSetFileOp-response"
  "jetmax_control/ActionSetFileOpResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ActionSetFileOp)))
  ...
  "jetmax_control/ActionSetFileOp")