...
"""autogenerated by genpy from jetmax_control/ActionSetRawActionResult.msg. Do not edit."""
import codecs
import sys
...
class ActionSetRawActionResult(genpy.Message):
  _md5sum = "e5f62eb2cecdccdb33834c1bf0d40a1c"
  _type = "jetmax_control/ActionSetRawActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','jetmax_control/ActionSetRawResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ActionSetRawActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = jetmax_control.msg.ActionSetRawResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = jetmax_control.msg.ActionSetRawResult()
