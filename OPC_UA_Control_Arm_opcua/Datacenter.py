        ...
        for node in nodes:
            ...
            try:
                ...
                if nodeClass == "Variable":
                    ...
                    datatype = node.get_data_type().Identifier

                    if migrate:

                        datacenterNode = datacenterParentNode.add_variable(idx, name, value, datatype=datatype) if (datacenterParentNode is not None) else None
